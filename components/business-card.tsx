...
export default function BusinessCard({ onExpand, isExpanded }: BusinessCardProps) {
  ...
  const handleClick = () => {
    console.log("[v0] Card clicked - isExpanded:", isExpanded)
    if (isExpanded) return
    console.log("[v0] Calling onExpand from click")
    onExpand?.()
  }
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-background p-4 z-50">
      <div className="cursor-pointer" onMouseEnter={handleHover} onClick={handleClick}>
        <div
