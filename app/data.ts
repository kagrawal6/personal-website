...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    summary:
      "An xv6 memory-management extension with lazy wmap/wunmap, file-backed maps, ELF protections, copy-on-write fork, and tooling to inspect sharing and demand paging.",
    description:
